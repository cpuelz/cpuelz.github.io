...
\vspace{0.25cm}
\indent 
{\em Assistant Professor}  \hspace*{\fill} 9/2024-present \\
\indent
Department of Mathematics \\
\indent University of Houston

\vspace{0.1cm}
\indent
{\em Adjunct Assistant Professor} \hspace*{\fill} 7/2024-present \\
\indent
...
\vspace{0.1cm}
\indent
{\em Lecturer} \hspace*{\fill} 7/2020-7/2024 \\
\indent
Department of Computational Applied Mathematics and Operations Research \\
\indent Rice University 
...
\vspace{0.1cm}
\indent 
{\em Assistant Professor}  \hspace*{\fill} 8/2020-9/2024 \\
\indent
...
\indent Rice University
%\indent %advisors: Beatrice Riviere, Craig Rusin, Mark Embree 
...
%\indent %advisor: Laurent Demanet 

\vspace{0.1cm}
\indent
{\em Undergraduate Researcher} \hspace*{\fill} Summer 2009 \\
\indent Max Planck Institute for Dynamics and Self-Organization
...
\begin{etaremune}
\item ``Parameter selection and optimization of a computational network model of blood flow in single-ventricle patients.'' \\
A.M. Taylor-LaPole, L.M. Paun, D. Lior, J.D. Weigand, C. Puelz, M.S. Olufsen \\
{\em submitted}, 2024.
\item ``Fluid-structure interaction simulations for the prediction of fractional flow reserve in pediatric patients with anomalous aortic origin of a coronary artery.'' \\
C. Puelz, C.G. Rusin, D. Lior, S. Sachdeva, T.T. Doan, L.F. Eilers, D. Reaves-O’Neal, S. Molossi. \\
{\em submitted}, 2024.
    \item ``Deformable registration of MRA images with 4D Flow images to facilitate accurate estimation of flow properties within blood vessels.'' \\
 D.U. Lior, C. Puelz, J. Weigand, K.V. Montez$^\star$, Y.
  Wang$^\star$, S. Molossi, D.J. Penny, C.G. Rusin \\
  {\em submitted}, 2023.
...
{\em submitted}, 2023.
  \item ``Computational framework for the generation of one-dimensional vascular models accounting for uncertainty in networks extracted from medical images.'' \\
  M.A. Bartolo, A.M. Taylor-LaPole, D. Gandhi, A. Johnson, Y. Li, E. Slack, I. Stevens, Z. Turner, C. Puelz, D. Husmeier, M.S. Olufsen. \\
    {\em Journal of Physiology}, {\em accepted}, 2024.
\item ``Anomalous Aortic Origin of a Coronary Artery in Pediatric Patients.'' \\
T. Doan, C. Puelz, C. Rusin, S. Molossi. \\
{\em Current Pediatrics Reports}, {\em accepted}, 2024.
\item ``Predicting the effects of surgically determined parameters on exercise tolerance in Fontan patients.'' \\
  ...
  {\em Medical Engineering and Physics}, {\em accepted}, 2024.
...
{\em Biomechanics and Modeling in Mechanobiology}, 22(1), pp. 357-377, 2023.
...
{\em Annals of Biomedical Engineering}, 51(1), pp. 189-199, 2023.
...
{\em Annals of Biomedical Engineering}, 51(1), pp. 103-116, 2023.
...
{\em Mathematical Medicine and Biology}, 40(1), pp. 1-23, 2023.
...
\begin{enumerate}
\item ``High-risk variables in anomalous aortic origin of the right coronary artery: results from supervised and unsupervised learning.'' Oral Presentation. S. Molossi, C. Puelz, D. Puelz, D. Reaves-O'Neal. {\em Annual Meeting for the Associate of Paediatric and Congenital Cardiology}, May 8-11, 2024, Porto, Portugal.

\item ``Identification of high-risk variables for pediatric patients with anomalous aortic origin of the right coronary using statistical modeling.'' Oral Presentation. C. Puelz, D. Puelz, D. Reaves-O'Neal, S. Molossi. {\em 73rd Annual Scientific Session of the American College of Cardiology}, April 6-8, 2024, Atlanta, GA.
\item ``Computer simulation for the prediction of coronary flow and pressure in pediatric patients with anomalous coronaries.'' Poster. C. Puelz, D. Lior, D. Reaves-O'Neal, C. Rusin, S. Molossi. {\em 73rd Annual Scientific Session of the American College of Cardiology}, April 6-8, 2024, Atlanta, GA.  
\item ``A hyperelastic immersed boundary finite element model of the human heart.'' Oral Presentation. C. Puelz, D. Wells, M. A. Smith, S. Rossi, P. Segars, G. Sturgeon and B. E. Griffith. {\em 6th International Conference on Computational and Mathematical Biomedical Engineering}, Sendai, Japan, 2019.  
\item ``Mathematical investigation of impact of recirculation in patients receiving tandem extracorporeal membrane oxygenation and therapeutic plasma exchange.'' Oral Presentation. C. Puelz, Y.A. Park, J. Marinaro, C.S. Peskin, B.E. Griffith, J.S. Raval. {\em Journal of Clinical Apheresis}: Special Issue Abstracts from the American Society for Apheresis 40th Annual Meeting 34(2), 88-89, 2019.
\item ``Immersed boundary finite element hyperelastic heart model.'' Oral Presentation. C. Puelz, M.A. Smith, S. Rossi, G. Sturgeon, P. Segars, and B. Griffith. {\em ECCM-ECFD 2018}, Glasgow, Scotland.
\end{enumerate}
...
\begin{itemize}
\item Career Champion Award, Rice Center for Career Development, August 2023.
...
\begin{tabular}{ l  l  l  l  }
  %{\bf Course } & {\bf Date } &  {\bf Institution} & {\bf Role} \\
  Differential Equations in Science and Engineering (undergraduate) & S 2024 & Rice & Instructor \\
Differential Equations in Science and Engineering (undergraduate) & F 2023 & Rice & Instructor \\
...
{\bf \large Mentoring}
\begin{itemize}
\item Hubert King, Rice undergraduate engineering student. \\
January 2024-present. \\
Topics: phyics-informed neural networks, fluid mechanics of the Fontan circulation.
\item Yimo Wang, Rice undergraduate engineering student. \\
January 2023-August 2023. \\
Topics: Automation of computer aided design for cardiac models and calculation of wall shear stress from imaging data.
\item Poom Kritpracha, Rice undergraduate engineering student, co-advised with Beatrice Riviere. \\
May 2022-May 2023 \\
Topic: Numerical methods and models for species transport in the human body.
\item Kristina Montez, Rice undergraduate engineering student, co-advised with Dan Lior. \\
May 2022-May 2023 \\
Topic: Image segmentation and model construction for anomalous aortic origin of coronary arteries.
\item Damian Gonzalez, Rice undergraduate engineering student. \\
January 2022-May 2022 \\
Topic: Control of the circulation using compartmental models.
\item Katie Bablak, Rice undergraduate engineering student, co-advised with Dan Lior. \\  January 2022-May 2022 \\
Topic: Model construction of single ventricle physiology
\item Colin Edwards, Rice undergraduate engineering student, co-advised with Craig Rusin and Dan Lior.\\ June 2021-May 2022. \\
Topic: Image segmentation and model construction for anomalous aortic origin of coronary arteries.
...
\item Zan Ahmad, NYU undergraduate mathematics student (SURE program). \\Spring-Summer 2020. \\
...
\item Zach Danial, NYU undergraduate student (AM-SURE program), with Charlie Peskin.\\ Summer 2019.\\
Topic: Species advection in fluid with simple and three dimensional models.
\item Lynn Jin, NYU undergraduate student (SURE program, summer 2019), with Charlie Peskin. \\ Fall 2018-Summer 2019. \\  Topic: Zero dimensional pulsatile models for the fenestrated Fontan and fetal physiologies.
\item Margaret Anne Smith, post-bachelors student at UNC-CH, with Boyce Griffith. \\Fall 2017-Fall 2018. \\
...
\begin{itemize}
\item Co-organizer for minisymposium titled ``Translational Mathematical Modeling and Data Science in Medicine,'' SIAM TX/LA meeting, November 2023.
...
\begin{enumerate}
\item ``Computational cardiology: from vessel network modeling to cardiac fluid-structure interaction.'' \\
Laboratory for Systems Medicine Seminar Series, June 4, 2024.
\item ``Computer modeling and image processing to study hemodynamics in congenital heart defects.'' \\
2024 Annual Society of Thermal Medicine Meeting, May 15, 2024.
\item ``Identification of high-risk variables for pediatric patients with anomalous aortic origin of the right coronary using statistical modeling.'' \\
73rd Annual Scientific Session of the American College of Cardiology, April 7, 2024.
\item ``Mathematical models and numerical methods for computational physiology and medicine.'' \\
University of Houston Mathematics Department, January 18, 2024.
\item ``Computer models and image processing to study surgeries for the treatment of single ventricle physiology.''\\
6th Annual Meeting of the SIAM Texas-Louisiana Section, November 3, 2023.
\item ``Modeling the interplay between blood flow and oxygen transport in the defective heart. '' \\
SIAM DS 2023, May 16, 2023.
...
{\bf \large Posters}
\begin{enumerate}
\item ``Computer simulation for the prediction of coronary flow and pressure in pediatric patients with anomalous coronaries.''
with D. Lior, D. Reaves-O'Neal, C. Rusin, S. Molossi.\\ 
73rd Annual Scientific Session of the American College of Cardiology, April 2024. 
...
\begin{itemize}
\item 2024 Annual Society of Thermal Medicine Meeting, May 13-15, 2024.
\item 73rd Annual Scientific Session of the American College of Cardiology, April 6-8, 2024, Atlanta, GA.
\item 6th Annual Meeting of the SIAM Texas-Louisiana Section, November 3-5, 2023.
\item 2023 SIAM DS Meeting, Portland, Oregon, May 14-18, 2023.
